...
void subKeyProcess()
{
  ...
  // HAL_GPIO_TogglePin(LED1_GPIO_Port, LED1_Pin);  // Ví dụ: bật/tắt LED
  ...
  if ((KeyReg1 == KeyReg0) && (KeyReg1 == KeyReg2))
  {
    ...
    else
    {
      ...
      if (TimeOutForKeyPress == 0)
      {
        ...
        if (KeyReg3 == PRESSED_STATE)
        {
          button1_flag = 1; // Kích hoạt sự kiện long press
                            // Lưu ý: Code này chưa sử dụng button1_long_pressed
        }
      }
    }
  }
